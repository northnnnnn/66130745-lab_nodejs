...
const users = [
  {
    ...
    fullname: "Caelus",
    avatar:
      "https://static.wikia.nocookie.net/shipping/images/7/7f/Character_Caelus_29_Destruction_Portrait.webp/revision/latest?cb=20230516205559",
  },
  {
    id: 2,
    fullname: "March 7th",
...
router.post("/user/login", function (req, res) {
  ...
  if (username === "NORTHSTAR" && password === "1774") {
